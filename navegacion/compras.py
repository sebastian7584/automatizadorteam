...
class Compras:
    ...
    #     self.legalizador = ''
        ...
        self.title_user = label.Label().create_label(self.menu.submenu, 'Usuario: ', 0.0, 0.20, 0.3,0.2, letterSize= 14)
        self.title_password = label.Label().create_label(self.menu.submenu, 'Clave: ', 0.0, 0.35, 0.25,0.05, letterSize= 14)
        self.title_first_date = label.Label().create_label(self.menu.submenu, 'Fecha inicial: ', 0.0, 0.43, 0.45,0.05, letterSize= 14)
        self.title_last_date = label.Label().create_label(self.menu.submenu, 'Fecha final: ', 0.0, 0.50, 0.4,0.05, letterSize= 14)
        ...
        input_password= ctk.CTkEntry(self.menu.submenu, textvariable=self.entry_user)
        input_password.place(relx=0.4, rely=0.32, relheight=0.05, relwidth=0.6)
        input_first_date= ctk.CTkEntry(self.menu.submenu, textvariable=self.entry_user)
        input_first_date.place(relx=0.4, rely=0.39, relheight=0.05, relwidth=0.6)
        input_last_date= ctk.CTkEntry(self.menu.submenu, textvariable=self.entry_user)
